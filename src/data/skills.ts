...
export const skillsData: Skill[] = [
	...
	// },
	{
		id: "unity",
		name: "Unity3D",
		description: "行业领先的实时3D内容创作与运营平台",
	...
	},
	{
		...
		name: "Sublime Text",
		description:
			"轻便的代码编辑器，支持多种编程语言的语法高亮、拥有优秀的代码自动完成功能。",
	...
	},
	{
		id: "vs",
		name: "Visual Studio",
		description: "一个功能丰富的平台，用于编写、编辑、调试和部署应用程序。",
	...
	// Other Skills
	{
		id: "excel",
		name: "Excel",
		description: "强大的电子表格软件，数据分析和可视化的利器。",
	...
	},
	{
		id: "vercel",
		name: "Vercel",
		description: "用于构建、部署和扩展无服务器应用程序和静态网站。",
